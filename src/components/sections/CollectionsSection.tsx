  ...
  return (
    <div className="info-section p-4 mb-4 bg-white dark:bg-gray-800 rounded shadow">
      ...
      <section className="mb-8">
        ...
        <img src="/media/7.01.gif" alt="Collections framework interface structure" className="my-4" />
        <img src="/media/7.0.1.1.gif" alt="Collection Implementations" className="my-4" />
      ...
      <section className="mb-8">
        ...
        <img src="/media/7.02.gif" alt="ArrayList demonstration" className="my-4" />
        <img src="/media/7.0.2.2.gif" alt="ArrayList characteristics" className="my-4" />
...
Rectangle r = list.get(0); // No cast needed`}
        ...
        <div className="mb-4">
          ...
          <img src="/media/7.03a.gif" alt="ArrayList arbitrary elements" className="my-4" />
          <img src="/media/7.03b.gif" alt="Objects of Rectangle in ArrayList" className="my-4" />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <img src="/media/7.04.gif" alt="ArrayList same-type elements" className="my-4" />
        </div>
        <div className="mb-4">
          <b>Demonstration 3:</b> Managing a list of students with ArrayList.
          <img src="/media/7.05.gif" alt="Class Design" className="my-4" />
          <img src="/media/7.06a.gif" alt="Algorithm 1" className="my-4" />
          <img src="/media/7.06b.gif" alt="Algorithm 2" className="my-4" />
          <img src="/media/7.06c.gif" alt="Algorithm 3" className="my-4" />
          <img src="/media/7.06d.gif" alt="Algorithm 4" className="my-4" />
          <img src="/media/7.06e.gif" alt="Algorithm 5" className="my-4" />
          <img src="/media/7.06f.gif" alt="Algorithm 6" className="my-4" />
          <img src="/media/7.06g.gif" alt="Algorithm 7" className="my-4" />
          <img src="/media/7.06h.gif" alt="Algorithm 8" className="my-4" />
          <img src="/media/7.06i.gif" alt="Algorithm 9" className="my-4" />
          <img src="/media/7.06j.gif" alt="Algorithm 10" className="my-4" />
          <img src="/media/7.06k.gif" alt="Algorithm 11" className="my-4" />
        </div>
        <div className="mb-4">
          <b>Test cases:</b>
...
Choose 1..6:`}
          ...
          <img src="/media/7.0.6l.gif" alt="Student managing menu" className="my-4" />
        </div>
      </section>
      <section className="mb-8">
        ...
        <img src="/media/7.07.gif" alt="TreeSet structure" className="my-4" />
        ...
        <div className="mb-4">
          ...
          <img src="/media/7.13.gif" alt="TreeSet error" className="my-4" />
        </div>
        <div className="mb-4">
          <b>Demonstration 2:</b> TreeSet of integers (Integer implements Comparable, no duplicates allowed).
          <img src="/media/7.14.gif" alt="TreeSet of integers" className="my-4" />
        </div>
        <div className="mb-4">
          <b>Demonstration 3:</b> TreeSet of user-defined objects (Student), with add, search, remove, ascending and descending traversal.
          <img src="/media/7.15a.gif" alt="TreeSet students a" className="my-4" />
          <img src="/media/7.15b.gif" alt="TreeSet students b" className="my-4" />
          <img src="/media/7.15c.gif" alt="TreeSet students c" className="my-4" />
          <img src="/media/7.15d.gif" alt="TreeSet students d" className="my-4" />
          <img src="/media/7.15e.gif" alt="TreeSet students e" className="my-4" />
          <img src="/media/7.15f.gif" alt="TreeSet students output" className="my-4" />
        </div>
      </section>
      <section className="mb-8">
        ...
        <img src="/media/7.16.gif" alt="Map structure" className="my-4" />
        ...
        <img src="/media/7.17.gif" alt="Hash function and hash-table" className="my-4" />
        ...
        <div className="mb-4">
          ...
          <img src="/media/7.18a.gif" alt="HashMap demo 1" className="my-4" />
          <img src="/media/7.18b.gif" alt="HashMap demo 2" className="my-4" />
          <img src="/media/7.18c.gif" alt="HashMap demo 3" className="my-4" />
          <img src="/media/7.18d.gif" alt="HashMap demo 4" className="my-4" />
          <img src="/media/7.18e.gif" alt="HashMap demo 5" className="my-4" />
          <img src="/media/7.18f.gif" alt="HashMap demo 6" className="my-4" />
          <img src="/media/7.18g.gif" alt="HashMap output" className="my-4" />
        </div>
      </section>
      <section className="mb-8">
        ...
        <div className="mb-4">
          ...
          <img src="/media/7.19a.gif" alt="Sorting ArrayList of employees" className="my-4" />
          <img src="/media/7.19b.gif" alt="Sorting by salary" className="my-4" />
          <img src="/media/7.19c.gif" alt="Sorting output" className="my-4" />
          <img src="/media/7.19d.gif" alt="Sorting output 2" className="my-4" />
        </div>
      </section>
      <section className="mb-8">
