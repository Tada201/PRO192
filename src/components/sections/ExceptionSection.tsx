  ...
  return (
    <div className="info-section p-4 mb-4 bg-white dark:bg-gray-800 rounded shadow">
      ...
      <section className="mb-8">
        ...
        <img src="/media/exception.png" alt="Exception example" className="my-4" />
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <img src="/media/exception2.png" alt="Checked Exception" className="my-4" />
        ...
        <img src="/media/exception1.png" alt="Unchecked Exception" className="my-4" />
      </section>
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2">How to Fix</h2>
        <h3 className="text-xl font-semibold mb-2">try-catch Mechanism</h3>
        <img src="/media/exception3.png" alt="try-catch flow" className="my-4" />
        ...
        <img src="/media/exception5.png" alt="try-catch example" className="my-4" />
        ...
        <img src="/media/exception4.png" alt="ArrayIndexOutOfBounds example" className="my-4" />
        ...
        <img src="/media/exception6.png" alt="throws example" className="my-4" />
      ...
      <section className="mb-8">
        ...
        <img src="/media/exception7.png" alt="Exception example code" className="my-4" />
        <p className="mb-4">If you input a text instead of a number, an exception is thrown and caught. The output will be:</p>
        <img src="/media/exception8.png" alt="Exception output 1" className="my-4" />
        <p className="mb-4">If you input 18, the code throws a new Exception. The output will be:</p>
        <img src="/media/exception9.png" alt="Exception output 2" className="my-4" />
      </section>
      <section className="mb-8">
