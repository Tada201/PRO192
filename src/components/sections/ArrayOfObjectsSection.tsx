...
const ArrayOfObjectsSection = () => {
  return (
	...
	public static void main(String[] args){
        ...
        <img src="/Org_code/images/array3.png" alt="array3" className="my-4" />
	...
	public static void main(String[] args){
        ...
        <img src="/Org_code/images/array4.png" alt="array4" className="my-4" />
	...
	public static void main(String[] args){
        ...
        <img src="/Org_code/images/array5.png" alt="array5" className="my-4" />
      ...
      <section className="mb-8" id="file">
        ...
        <img src="/Org_code/images/IO.01.gif" alt="IO.01" className="my-4" />
        <img src="/Org_code/images/IO.02.gif" alt="IO.02" className="my-4" />
        ...
        <img src="/Org_code/images/IO.09A.gif" alt="IO.09A" className="my-4" />
        <img src="/Org_code/images/IO.09B.gif" alt="IO.09B" className="my-4" />
        <img src="/Org_code/images/IO.09C.gif" alt="IO.09C" className="my-4" />
        <img src="/Org_code/images/IO.09D.gif" alt="IO.09D" className="my-4" />
        <p>Result in 3 cases:</p>
        <img src="/Org_code/images/IO.09E.gif" alt="IO.09E" className="my-4" />
        ...
        <img src="/Org_code/images/IO.10.gif" alt="IO.10" className="my-4" />
        <img src="/Org_code/images/IO.11.gif" alt="IO.11" className="my-4" />
      </section>
      <section className="mb-8" id="build">
        ...
        <img src="/Org_code/images/IO.12A.gif" alt="IO.12A" className="my-4" />
        ...
        <img src="/Org_code/images/IO.12B.gif" alt="IO.12B" className="my-4" />
        ...
        <img src="/Org_code/images/IO.12C.gif" alt="IO.12C" className="my-4" />
        <img src="/Org_code/images/IO.12D.gif" alt="IO.12D" className="my-4" />
        ...
        <img src="/Org_code/images/IO.12E.gif" alt="IO.12E" className="my-4" />
        <img src="/Org_code/images/IO.12F.gif" alt="IO.12F" className="my-4" />
        <img src="/Org_code/images/IO.12G.gif" alt="IO.12G" className="my-4" />
        <img src="/Org_code/images/IO.12H.gif" alt="IO.12H" className="my-4" />
        <img src="/Org_code/images/IO.12I.gif" alt="IO.12I" className="my-4" />
        <img src="/Org_code/images/IO.12J.gif" alt="IO.12J" className="my-4" />
        <img src="/Org_code/images/IO.12K.gif" alt="IO.12K" className="my-4" />
        <img src="/Org_code/images/IO.12L.gif" alt="IO.12L" className="my-4" />
        <img src="/Org_code/images/IO.12M.gif" alt="IO.12M" className="my-4" />
        <img src="/Org_code/images/IO.12N.gif" alt="IO.12N" className="my-4" />
        <img src="/Org_code/images/IO.12O.gif" alt="IO.12O" className="my-4" />
        <img src="/Org_code/images/IO.12P.gif" alt="IO.12P" className="my-4" />
        <img src="/Org_code/images/IO.12Q.gif" alt="IO.12Q" className="my-4" />
        <img src="/Org_code/images/IO.12R.gif" alt="IO.12R" className="my-4" />
        <img src="/Org_code/images/IO.12S.gif" alt="IO.12S" className="my-4" />
        <img src="/Org_code/images/IO.12T.gif" alt="IO.12T" className="my-4" />
        ...
        <img src="/Org_code/images/IO.16.gif" alt="IO.16" className="my-4" />
        <p>The following image helps us explore the structure of an object file in Java.</p>
        <img src="/Org_code/images/IO.17.gif" alt="IO.17" className="my-4" />
        <ol className="list-decimal list-inside mb-4">
        ...
        <img src="/Org_code/images/IO.18A.gif" alt="IO.18A" className="my-4" />
        <img src="/Org_code/images/IO.18B.gif" alt="IO.18B" className="my-4" />
        <img src="/Org_code/images/IO.18C.gif" alt="IO.18C" className="my-4" />
        <img src="/Org_code/images/IO.18D.gif" alt="IO.18D" className="my-4" />
        <img src="/Org_code/images/IO.18E.gif" alt="IO.18E" className="my-4" />
        <img src="/Org_code/images/IO.18F.gif" alt="IO.18F" className="my-4" />
        <img src="/Org_code/images/IO.18G.gif" alt="IO.18G" className="my-4" />
        <img src="/Org_code/images/IO.18H.gif" alt="IO.18H" className="my-4" />
        <p>The result:</p>
        <img src="/Org_code/images/IO.18I.gif" alt="IO.18I" className="my-4" />
        <span className="font-semibold">Exercise</span>
        <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded mb-4 whitespace-pre-line">
