  ...
  return (
    <>
      <div className="info-section p-4 mb-4 bg-white dark:bg-gray-800 rounded shadow">
        ...
        <img src="/media/algorithmic.png" alt="Algorithmic structure diagram" className="mb-4 rounded shadow" />
        ...
        <img src="/media/class_relationships.png" alt="Class relationships diagram" className="mb-4 rounded shadow" />
        ...
        <img src="/media/abstraction.png" alt="Abstraction diagram" className="mb-4 rounded shadow" />
        ...
        <img src="/media/classes.png" alt="Classes diagram" className="mb-4 rounded shadow" />
        ...
        <img src="/media/classUML.png" alt="Class UML diagram" className="mb-4 rounded shadow" />
        ...
        <img src="/media/encapsulation.png" alt="Encapsulation diagram" className="mb-4 rounded shadow" />
        ...
        <img src="/media/differentBehavior.png" alt="Different behavior diagram" className="mb-4 rounded shadow" />
        <img src="/media/identicalBehavior.png" alt="Identical behavior diagram" className="mb-4 rounded shadow" />
