  ...
  return (
    <div className="info-section p-4 mb-4 bg-white dark:bg-gray-800 rounded shadow">
      ...
      <section className="mb-8">
        ...
        <img src="/images/inheritance1.png" alt="Inheritance Example 1" className="my-4" />
        ...
        <img src="/images/inheritance2.png" alt="Inheritance Example 2" className="my-4" />
      ...
      <section className="mb-8">
        ...
        <img src="/images/inheritance3.png" alt="Inheritance Example 3" className="my-4" />
      ...
      <section className="mb-8">
        ...
        <img src="/images/inheritance4.png" alt="Inheritance Example 4" className="my-4" />
        ...
        <img src="/images/inheritance5.png" alt="Inheritance Example 5" className="my-4" />
...
and taking ...</pre>
        ...
        <img src="/images/hidden method.png" alt="Hidden Method" className="my-4" />
      </section>
      <section className="mb-8">
...
`}
        ...
        <img src="/images/inheritance6.png" alt="Inheritance Example 6" className="my-4" />
