  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 bg-blue-100 dark:bg-gray-900 rounded shadow">
      ...
      <section>
        ...
        <img src="/Org_code/images/algorithmic.png" alt="Algorithmic diagram" />
        <p>
        ...
        <img src="/Org_code/images/class_relationships.png" alt="Class relationships diagram" />
        <p>
        ...
        <img src="/Org_code/images/abstraction.png" alt="Abstraction diagram" />
        <p>
        ...
        <img src="/Org_code/images/classes.png" alt="Classes diagram" />
        <br />
        ...
        <p>where visibility is one of:<br />
          ...
          '#': protected<br />
          ' ': default(package)<br />
          <img src="/Org_code/images/classUML.png" alt="Class UML diagram" />
        </p>
        ...
        <p>
          ...
          <img src="/Org_code/images/encapsulation.png" alt="Encapsulation diagram" />
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          <img src="/Org_code/images/differentBehavior.png" alt="different behavior polymorphism" />
          <img src="/Org_code/images/identicalBehavior.png" alt="identical behavior polymorphism" />
        </p>
        <p>
      ...
      <section>
        <h2>Course Slide</h2>
        <ul>
          <li><a href="/Org_code/resource/Introduction.pdf" download>Introduction.pdf</a></li>
        </ul>
        <br />
      </section>
    </div>
